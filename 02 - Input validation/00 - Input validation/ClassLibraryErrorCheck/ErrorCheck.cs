...
namespace ClassLibraryErrorCheck
{
    public static class ErrorCheck
    {
        ...
        {
            if (DataCheck.IsValidName(_textBox.Text))
                return false;
        ...
        {
            if (DataCheck.IsValidDate(_textBox.Text))
                return false;
            TriggerTextBoxError(_textBox, _error, _errorProvider);
            return true;
        }
        ...
        {
            if (DataCheck.IsValidAmount(_textBox.Text))
                return false;
            TriggerTextBoxError(_textBox, _error, _errorProvider);
            return true;
        }
        ...
        {
            if (DataCheck.IsValidZipCode(_textBox.Text))
                return false;
            TriggerTextBoxError(_textBox, _error, _errorProvider);
            return true;
        }
